...
print("Loading aligned CLIP embeddings...")
...
# Train-test split (identical split config to bert_baseline.py / multimodal_train.py)
...
# Train classifier
print("\nTraining CLIP-only classifier...")

with mlflow.start_run(run_name="clip_only"):

    mlflow.log_param("feature_set", "CLIP")
